                    ...
                    {
                        {
                            ...
                            var effectiveLongAxisLength = minLongAxisLength +
                                                          (1.0 - evParam) * (maxLongAxisLength - minLongAxisLength);
                            ...
                            Vector3d newAAxis = damping * _scaleEllipsoids * _ellipsoids[i].GetAAxis() + (1.0 - damping) * a * _evec1[i];
                            Vector3d newBAxis = damping * _scaleEllipsoids * _ellipsoids[i].GetBAxis() + (1.0 - damping) * b * _evec2[i];
                            Vector3d newCAxis = damping * _scaleEllipsoids * _ellipsoids[i].GetCAxis() + (1.0 - damping) * b * _evec3[i];
